...
<!-- Sidebar Menu -->
      <?php $page ='datatable';echo require_once("../connect/navbar.php");?>
  </aside>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <?php
					    ...
					    $query=mysqli_query($conn,"select * from `student_info`,`guardian_info` where student_info.StudentID = guardian_info.Stud_ID order by LastName");
              ...
              <td><?php echo $row['GuardianFirstName']; echo" "; echo $row['GuardianLastName']; ?></td>
              ...
              <td class="project-actions text-right">
                          ...
                          <a class="btn btn-info btn-sm" href="../registration/edit.php?id=<?php echo $row['StudentID'];?>">
                              <i class="fas fa-pencil-alt" title="Edit">
                              </i>
                          </a>
                          <a class="btn btn-secondary btn-sm" onclick="return submitForm(<?php echo $row['StudentID'];?>)">
                              <i class="fas fa-archive" title="Archive">
                              </i>
                          </a>
                      </td>
              </tr>
...
<script>
  ...
  function submitForm($studentID){
              ...
              .then((isOkay)=>{
                if (isOkay){
                  location.assign("../registration/archive.php?id=" + $studentID);
                }
              });
              return false;
            }
