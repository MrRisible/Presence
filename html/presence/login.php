          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <tbody>
                ...
                $query=mysqli_query($conn,"SELECT * FROM `student_info`,`studentin` WHERE CONCAT(student_info.FirstName,' ',student_info.LastName) = studentin.Name and studentin.Date = '$date'");
