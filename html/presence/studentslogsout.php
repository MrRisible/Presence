...
<!-- Sidebar Menu -->
      <?php $page ='logsout';echo require_once("../connect/navbar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Student Logs: Out</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <tbody>
                ...
                $query=mysqli_query($conn,"SELECT * FROM `student_info`,`studentout` WHERE CONCAT(student_info.FirstName,' ',student_info.LastName) = studentout.Name and studentout.Date = '$date' order by ordering DESC LIMIT 300");
