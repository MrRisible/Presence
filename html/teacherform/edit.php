<?php
  ...
  $teacherID=$_GET['id'];
	$query=mysqli_query($conn,"select * from `teacher_info` where TeacherID='$teacherID'");
	$row=mysqli_fetch_array($query);

  $query3=mysqli_query($conn,"select * from `accounts` where id='$teacherID'");
...
<!-- Sidebar Menu -->
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
            ...
            <form action="update.php?id=<?php echo $teacherID; ?>" method="post" onsubmit="return submitForm(this);" >
            <div class="row">
  <div class="col-lg-6 col-12">
    <div class="card">
      ...
      <div class="form-group">
                    <label for="inputRFID">Teacher ID</label>
                    <input type="text" class="form-control" name="teacherID" value="<?php echo $row['TeacherID']?>" required="required">
                  </div>
                  <div class="form-group">
                    <label for="inputStudID">First Name</label>
                    <input type="text" class="form-control" name="teacherFirstName" value="<?php echo $row['FirstName']?>" required="required">
                  </div>
                  <div class="form-group">
                    <label for="inputFirstName">Last Name</label>
                    <input type="text" class="form-control" name="teacherLastName" value="<?php echo $row['LastName']?>" required="required">
                  </div>
                  <br>
        </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="teacherUserName" value="<?php echo $row3['username'];?>" readonly>
                  </div>
                
                  <div class="form-group">
                   <a class="btn btn-outline-warning" href="resetpass.php?id=<?php echo $row['TeacherID'];?>">
