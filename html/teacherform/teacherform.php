...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Sidebar Menu -->
      <?php $page ='teachform';echo require_once("../connect/navbar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Teacher Registration</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- /.content-header -->
            ...
            <form action="register.php" method="post" onsubmit="return submitForm(this)">
            <div class="row">
    ...
    <div class="card">
      ...
      <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="teacherFirstName" placeholder="First Name" required="required">
                  </div>
                  <div class="form-group">
                    <label for="inputFirstName">Last Name</label>
                    <input type="text" class="form-control" name="teacherLastName" placeholder="Last Name" required="required">
                  </div>
                  <br>
        </div>
    </div>
                ...
                <div class="card-footer">
                  <button type="submit" name="register" class="btn btn-primary swalDefaultSuccess">Submit</button>
                </div>
            </form>
